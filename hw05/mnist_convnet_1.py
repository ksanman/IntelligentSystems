...
validX = X[50000:]
validY = Y[50000:]
# make sure you reshape the training and testing data
# are reshaped as follows.
...
# change these two paths accordingly; these are the files
# where the validation data and targets are peristed.
...
# with a specified batch size; these are the params
# I used to train my nets with; feel free to modify
# these numbers.
NUM_EPOCHS = 30
BATCH_SIZE = 10
...
MODEL.save('my_mnist_net/hw05_my_net_01.tfl')
